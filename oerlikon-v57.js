(() => {
  ...
  if (window.__SIMON_OERLIKON_V57__) return;
  ...
  window.SimonOerlikonV57 = Object.freeze({
    VERSION,
    POS,
    cloneTravelState,
    install,
  ...
  console.info(
    "Oerlikon v57: Salersteig, WG, Kirchenpark, Coop und Sternen Oerlikon registriert."
  );
})();
