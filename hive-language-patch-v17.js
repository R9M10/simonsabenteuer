(() => {
  ...
  if (window.__SIMON_HIVE_LANGUAGE_V17__) return;
  window.__SIMON_HIVE_LANGUAGE_V17__ = true;
  ...
  window.startSimonGame = function startSimonGameWithHiveLanguageV17(options = {}) {
  ...
  function installPatch(hive) {
    if (!hive || hive.__simonHiveLanguageV17) return;
    hive.__simonHiveLanguageV17 = true;
    ...
    if (typeof hive.init === "function") {
      ...
      hive.init = function initLanguageV17(data = {}) {
    ...
    hive.startRejectedDanceInvite = function startRejectedDanceInviteV17() {
      this.closeModal();
    ...
    if (typeof hive.leaveHive === "function") {
      ...
      hive.leaveHive = function leaveHiveV17(...args) {
    ...
    console.info(
      "HIVE Sprachpatch v17 aktiv: Hochdeutsche Menüs + gewünschter Bar-Dialog."
    );
  }
})();
