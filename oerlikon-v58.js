(() => {
  ...
  if (window.__SIMON_OERLIKON_V58__) return;
  ...
  class OerlikonScene extends (BaseScene || Phaser.Scene) {
    ...
    enterWG() {
      ...
      try {
        ...
        console.error("Oerlikon v57: WG konnte nicht geöffnet werden:", error);
        this.setUILocked?.(false);
      }
    }
    ...
    startArrivalAtSalersteig() {
      ...
      this.time.delayedCall(2600, () => {
        if (
          ...
          console.warn(
            "Oerlikon v58: Ankunft per Failsafe abgeschlossen."
          );
  ...
  class WGInteriorScene extends Phaser.Scene {
    ...
    leaveWG() {
      ...
      try {
        ...
        console.error("Oerlikon v57: WG-Rückkehr fehlgeschlagen:", error);
      }
    }
  }
  ...
  class SimonRoomScene extends Phaser.Scene {
    ...
    leaveRoom() {
      ...
      try {
        ...
        console.error("Oerlikon v57: Zimmer-Rückkehr fehlgeschlagen:", error);
      }
    }
  }
  ...
  function startBahnhofToOerlikon(scene) {
    ...
    const enterOerlikon = () => {
      ...
      try {
        ...
        console.error(
          "Oerlikon v58: Salersteig-Start fehlgeschlagen:",
          error
        );
    ...
    scene.time.delayedCall(2600, () => {
      if (
        ...
        console.warn(
          "Oerlikon v58: Salersteig-Transfer per Failsafe gestartet."
        );
        enterOerlikon();
      }
    });
  ...
  console.info(
    "Oerlikon v58: Salersteig-Transfer repariert, Ankunft mit Failsafe."
  );
})();
