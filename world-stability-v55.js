(() => {
  ...
  if (window.__SIMON_WORLD_STABILITY_V55__) return;
  ...
  if (typeof previousStart === "function") {
    window.startSimonGame = function startSimonGameWorldStabilityV55(
      options = {}
    ) {
  ...
  window.SimonWorldStabilityV55 = Object.freeze({
    VERSION,
    HIVE_SHIFT,
    HIVE_DOOR_X,
    ...
    status() {
      ...
      return {
        ...
        eth:
          window.SimonETHV55?.status?.() || null
      };
    }
  });

  console.info(
    "World Stability v55: HIVE-Hitboxes/Cutscene an neue Position gebunden, Polybahn-Recovery aktiv."
  );
})();
